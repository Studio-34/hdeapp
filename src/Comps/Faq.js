...
let qAList = [
    ...
    },
    {
        ...
        answer: `This is a known issue that we are working on a permanent solution in our current update. The focus / brightness adjustment is very sensitive within the app. If your finger holds / drags on the screen outside of the zoom or record areas, the brightness can be accidentally over adjusted causing the white screen. Simply tap your finger in the middle of the screen to reset the focus / brightness.`
    },
    {
